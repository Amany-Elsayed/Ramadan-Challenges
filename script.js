...
"قال رسول الله ﷺ: استعن بالله ولا تعجز",
...
"قال رسول الله ﷺ: من صلى علي صلاة واحدة صلى الله عليه عشرا",
...
"قال رسول الله ﷺ: من سلك طريقا يطلب فيه علما سلك الله به طريقا من طرق الجنة",
"قال رسول الله ﷺ: آية المنافق ثلاث إذا حدث كذب وإذا وعد أخلف وإذا ائتمن خان",
...
"قال رسول الله ﷺ: الصدق يهدي إلى البر والبر يهدي إلى الجنة",
"قال رسول الله ﷺ: إذا مات الإنسان انقطع عمله إلا من ثلاث صدقة جارية أو علم ينتفع به أو ولد صالح يدعو له",
"قال رسول الله ﷺ: اقرأوا القرآن فإنه يجيء يوم القيامة شفيعا لصاحبه",
"قال رسول الله ﷺ: من كان يؤمن بالله واليوم الآخر فلا يؤذ جاره",
"قال رسول الله ﷺ: ما من شيء أثقل في ميزان المؤمن يوم القيامة من حسن الخلق",
"قال رسول الله ﷺ: من مات ولسانه رطب من ذكر الله مات شهيدا",
...
"صلِّ ركعتين بعد الوضوء بنية التقرب إلى الله",
...
shareImageBtn.onclick = async () => {
  const canvas = await html2canvas(quoteBox, { useCORS: true });
  canvas.toBlob(blob => {
...
downloadCongrats.onclick = async () => {
  const canvas = await html2canvas(congratsCard, { useCORS: true });
